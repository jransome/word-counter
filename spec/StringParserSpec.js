describe("StringParser", function(){
  ...
  var stringParser;
  var inputString = "This is a TEST input string. It is a nice-looking string.";
  var expectedLowercaseOutput = "this is a test input string. it is a nice-looking string.";
  var expectedArrayOutput = ['This', 'is', 'a', 'TEST', 'input', 'string', 'It', 'is', 'a', 'nice', 'looking', 'string'];
  var expectedParsedOutput = ['this', 'is', 'a', 'test', 'input', 'string', 'it', 'is', 'a', 'nice', 'looking', 'string'];
